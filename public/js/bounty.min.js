...
Ya+'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0">',d("movie",e),d("AllowScriptAccess",c.allowScriptAccess),d("quality",h.quality),c.wmode?d("wmode",c.wmode):"",d("bgcolor",c.bgColor),d("hasPriority","true"),c.debugFlash?d("FlashVars",h.FlashVars):"","</object>"].join("");else for(j in a=l.createElement("embed"),h)h.hasOwnProperty(j)&&a.setAttribute(j,h[j]);ra();i=G();if(h=qa())if(c.oMC=T(c.movieID)||l.createElement("div"),c.oMC.id)m=c.oMC.className,c.oMC.className=(m?m+" ":"movieContainer")+(i?" "+i:""),c.oMC.appendChild(a),z&&(j=c.oMC.appendChild(l.createElement("div")),j.className="sm2-object-box",j.innerHTML=n),K=!0;else{c.oMC.id=c.movieID;c.oMC.className="movieContainer "+i;j=i=null;c.useFlashBlock||(c.useHighPerformance?i={position:"fixed",width:"8px",height:"8px",bottom:"0px",left:"0px",overflow:"hidden"}:(i={position:"absolute",width:"6px",height:"6px",top:"-9999px",left:"-9999px"},k&&(i.left=Math.abs(parseInt(i.left,10))+"px")));eb&&(c.oMC.style.zIndex=1E4);if(!c.debugFlash)for(m in i)i.hasOwnProperty(m)&&(c.oMC.style[m]=i[m]);try{z||c.oMC.appendChild(a),h.appendChild(c.oMC),z&&(j=c.oMC.appendChild(l.createElement("div")),j.className="sm2-object-box",j.innerHTML=n),K=!0}catch(p){throw Error(v("domError")+" \n"+p.toString());}}return J=!0};W=function(){if(c.html5Only)return X(),!1;if(h||!c.url)return!1;h=c.getMovie(c.id);h||(N?(z?c.oMC.innerHTML=ta:c.oMC.appendChild(N),N=null,J=!0):X(c.id,c.url),h=c.getMovie(c.id));"function"===typeof c.oninitmovie&&setTimeout(c.oninitmovie,1);return!0};D=function(){setTimeout(Ja,1E3)};Ja=function(){var b,e=!1;if(!c.url||O)return!1;O=!0;n.remove(i,"load",D);if(da&&!Da)return!1;j||(b=c.getMoviePercent(),0<b&&100>b&&(e=!0));setTimeout(function(){b=c.getMoviePercent();if(e)return O=!1,i.setTimeout(D,1),!1;!j&&Wa&&(null===b?c.useFlashBlock||0===c.flashLoadTimeout?c.useFlashBlock&&ua():B({type:"ontimeout",ignoreInit:!0}):0!==c.flashLoadTimeout&&sa(!0))},c.flashLoadTimeout)};V=function(){if(Da||!da)return n.remove(i,"focus",V),!0;Da=Wa=!0;O=!1;D();n.remove(i,"focus",V);return!0};L=function(b){if(j)return!1;if(c.html5Only)return j=!0,C(),!0;var e=!0,d;if(!c.useFlashBlock||!c.flashLoadTimeout||c.getMoviePercent())j=!0,s&&(d={type:!A&&u?"NO_FLASH":"INIT_TIMEOUT"});if(s||b)c.useFlashBlock&&c.oMC&&(c.oMC.className=G()+" "+(null===c.getMoviePercent()?"swf_timedout":"swf_error")),B({type:"ontimeout",error:d,ignoreInit:!0}),F(d),e=!1;s||(c.waitForWindowLoad&&!ja?n.add(i,"load",C):C());return e};Ia=function(){var b,e=c.setupOptions;for(b in e)e.hasOwnProperty(b)&&(c[b]===g?c[b]=e[b]:c[b]!==e[b]&&(c.setupOptions[b]=c[b]))};ia=function(){if(j)return!1;if(c.html5Only)return j||(n.remove(i,"load",c.beginDelayedInit),c.enabled=!0,L()),!0;W();try{h._externalInterfaceTest(!1),Ka(!0,c.flashPollingInterval||(c.useHighPerformance?10:50)),c.debugMode||h._disableDebug(),c.enabled=!0,c.html5Only||n.add(i,"unload",ha)}catch(b){return F({type:"JS_TO_FLASH_EXCEPTION",fatal:!0}),sa(!0),L(),!1}L();n.remove(i,"load",c.beginDelayedInit);return!0};E=function(){if(M)return!1;M=!0;Ia();ra();!A&&c.hasHTML5&&c.setup({useHTML5Audio:!0,preferFlash:!1});Sa();c.html5.usingFlash=Ra();u=c.html5.usingFlash;!A&&u&&(Qa.push(na.needFlash),c.setup({flashLoadTimeout:1}));l.removeEventListener&&l.removeEventListener("DOMContentLoaded",E,!1);W();return!0};xa=function(){"complete"===l.readyState&&(E(),l.detachEvent("onreadystatechange",xa));return!0};pa=function(){ja=!0;n.remove(i,"load",pa)};oa=function(){if(Ca&&(c.setupOptions.useHTML5Audio=!0,c.setupOptions.preferFlash=!1,ca||Ua&&!q.match(/android\s2\.3/i)))ca&&(c.ignoreFlash=!0),w=!0};oa();za();n.add(i,"focus",V);n.add(i,"load",D);n.add(i,"load",pa);l.addEventListener?l.addEventListener("DOMContentLoaded",E,!1):l.attachEvent?l.attachEvent("onreadystatechange",xa):F({type:"NO_DOM2_EVENTS",fatal:!0})}var fa=null;if(void 0===i.SM2_DEFER||!SM2_DEFER)fa=new R;i.SoundManager=R;i.soundManager=fa})(window);$(function(){"use strict";var $body=$(document.body),$npc_table=$("#npcs"),$manual_refresh=$("#manual-refresh"),$error=$("#error"),error_template=$("#error-template").html(),min_sync_interval=5000,sync_interval=min_sync_interval,sync_timer,idle_time,idle_timer,prev_text,row_timer,has_played_sound=false,base_doc_title=document.title,error_messages={"exists":"A guild with that name has already been registered.","missing":"The <em>%s</em> field cannot be left blank.","length":"The <em>%s</em> field cannot be longer than <em>%d</em> characters.","mismatch":"The <em>%s</em> does not match.","invalid":"The <em>%s</em> contains invalid characters."},field_names={"guildname":"guild name","admin_pw":"admin password","admin_email":"admin email","admin_pw_confirm":"admin password confirmation","member_pw":"member password"},initTable,errorDialog,fetchState,postState,applyState,beginAutoSync,logIn,updateRow,incrementIdleTime;initTable=function(){var npc_row_template=$("#npc-row-template").html(),html;$npc_table.html(Mustache.render(npc_row_template,{NPCs:GBT.npc_list}));};errorDialog=function(view){$error.html(Mustache.render(error_template,view));window.location.hash="error-dialog";$error.find("a.button").focus();};fetchState=function(callback){$.ajax({url:"api/search_state",type:"GET",dataType:"json",success:function(response){if(response){GBT.search_state=response;applyState();}
if(typeof callback==="function"){callback(true);}},error:function(xhr){if(typeof callback==="function"){callback(false);}}});};applyState=function(){var count=0,state=GBT.search_state;$.each(state,function(short_name,status){var $row=$("#npc-"+short_name),$input;if(status.found){count+=1;}
$row.toggleClass("found",status.found);$input=$row.find(".player-name input");if(!$input.is(":focus")){$input.val(status.player);}});if(count>=GBT.npc_list.length){if(!has_played_sound){soundManager.play("all_found");has_played_sound=true;}}else{has_played_sound=false;}
$("#found-count").text(count);document.title="("+count+") "+base_doc_title;};postState=function(short_name,player,found,callback){if($body.hasClass("demo")){GBT.search_state[short_name].player=player;GBT.search_state[short_name].found=found;applyState();callback(true);return;}
$.ajax({url:"api/search_state",type:"POST",data:{short_name:short_name,player:player||"",found:!!found},dataType:"json",success:function(response){GBT.search_state=response;applyState();if(typeof callback==="function"){callback(true);}},error:function(xhr){if(typeof callback==="function"){callback(false,xhr.responseText);}}});};beginAutoSync=function(){if($body.hasClass("demo")){return;}
if(!idle_timer){idle_time=0;idle_timer=setInterval(incrementIdleTime,600000);}
fetchState(function(success){if(success){if(sync_interval>min_sync_interval){sync_interval=sync_interval/2;}}else{sync_interval=sync_interval*2;}
if(document.getElementById("toggle-autosync").checked){sync_timer=setTimeout(beginAutoSync,sync_interval);}});};logIn=function(is_admin){$body.removeClass("demo");$body.addClass("logged-in");if(is_admin){$body.addClass("admin");}
window.location.hash="";$("#logged-in-guildname").text(GBT.guild_data.guildname);$("#options-member-pw").val(GBT.guild_data.member_pw);$("#options-admin-email").val(GBT.guild_data.admin_email);if(GBT.search_state){applyState();}
beginAutoSync();};$("#register").submit(function(){var form=this,$submit_button=$(form).find('input[type="submit"]');$submit_button.addClass("working");$.ajax({url:form.action,type:form.method,data:{guildname:form.guildname.value,admin_email:form.admin_email.value,admin_pw:form.admin_pw.value,admin_pw_confirm:form.admin_pw_confirm.value,member_pw:form.member_pw.value},dataType:"json",success:function(response){GBT.guild_data=response.guild_data;logIn(true);window.alert("Success!");},error:function(xhr){var error=JSON.parse(xhr.responseText),view={message:error_messages[error[1]],code:xhr.status,prev_location:window.location.hash};view.message=view.message.replace("%s",field_names[error[0]]);view.message=view.message.replace("%d",error[2]);errorDialog(view);},complete:function(){$submit_button.removeClass("working");}});return false;});$("#login").submit(function(){var form=this,$submit_button=$(form).find('input[type="submit"]');$submit_button.addClass("working");$.ajax({url:form.action,type:form.method,data:{guildname:form.guildname.value,password:form.password.value},dataType:"json",success:function(response){GBT.guild_data=response.guild_data;GBT.search_state=response.search_state;logIn(response.is_admin);form.password.value="";},error:function(xhr){var view={message:"Invalid guild name or password.",code:xhr.status,prev_location:"#"};if(xhr.status===403){errorDialog(view);}else{window.alert(xhr.status+" "+xhr.statusText);}},complete:function(){$submit_button.removeClass("working");}});return false;});$("#log-out").click(function(){var $button=$(this);$button.addClass("working");$.ajax({url:"api/logout",type:"POST",success:function(){$body.removeClass("admin logged-in");window.location.hash="";clearTimeout(sync_timer);document.title=base_doc_title;},error:function(xhr){window.alert(xhr.statusCode());},complete:function(){$button.removeClass("working");}});});$("#reset-password").submit(function(){var form=this,$submit_button=$(form).find('input[type="submit"]');$submit_button.addClass("working");$.ajax({url:form.action,type:form.method,data:{guildname:form.guildname.value,admin_email:form.admin_email.value},dataType:"json",success:function(response){window.location.hash="";window.alert("Your password has been reset. Please check your email.");},error:function(xhr){var view={code:xhr.status,prev_location:"#forgot-password-dialog"},messages={"400":"Neither field can be left blank.","403":"Incorrect email address.","404":"No guild found called <em>%s</em>."};if(messages[xhr.status.toString()]){view.message=messages[xhr.status.toString()].replace("%s",form.guildname.value);errorDialog(view);}else{window.alert(xhr.status+" "+xhr.statusText);}},complete:function(){$submit_button.removeClass("working");}});return false;});$("#options").submit(function(){var form=this,$submit_button=$(form).find('input[type="submit"]'),data={};$submit_button.addClass("working");if(form.member_pw.value){data.member_pw=form.member_pw.value;}
if(form.admin_email.value){data.admin_email=form.admin_email.value;}
if(form.admin_pw.value){data.admin_pw=form.admin_pw.value;data.admin_pw_confirm=form.admin_pw_confirm.value;}
$.ajax({url:form.action,type:form.method,data:data,dataType:"json",success:function(response){GBT.guild_data.member_pw=response.member_pw;GBT.guild_data.admin_email=response.admin_email;form.admin_pw.value="";form.admin_pw_confirm.value="";window.location.hash="";},error:function(xhr){var error=JSON.parse(xhr.responseText),view={message:error_messages[error[1]],code:xhr.status,prev_location:window.location.hash};view.message=view.message.replace("%s",field_names[error[0]]);view.message=view.message.replace("%d",error[2]);errorDialog(view);},complete:function(){$submit_button.removeClass("working");}});return false;});$(window).on("hashchange",function(){var hash=window.location.hash,$input;if(!hash||hash==="#"){return;}
$input=$(hash+" > form > input").first();$input.focus();});$("#demo-toggle").click(function(){$body.toggleClass("demo");if(!$body.hasClass("demo")){document.title=base_doc_title;}});updateRow=function($row,found){var $buttons=$row.find("button");$buttons.addClass("working");postState($row.attr("id").slice(4),$row.find(".player-name input").val(),found,function(success,error_message){$buttons.removeClass("working");});};$npc_table.on("click","button",function(){var $button=$(this);updateRow($button.closest(".npc-row"),$button.hasClass("found"));}).on("keydown",".player-name input",function(){var input=this,$row=$(this).closest(".npc-row");if(row_timer){clearTimeout(row_timer);}
if(prev_text&&this.value!==prev_text){row_timer=setTimeout(function(){updateRow($row,$row.hasClass("found"));},300);}
prev_text=input.value;}).on("blur",".player-name input",function(){var $row=$(this).closest(".npc-row");updateRow($row,$row.hasClass("found"));});$("#toggle-autosync").change(function(){$manual_refresh.toggleClass("disabled",this.checked);if(this.checked){beginAutoSync();}else{clearTimeout(sync_timer);}});$manual_refresh.click(function(){fetchState();});$("#reset").click(function(){var $button=$(this);$button.addClass("working");postState("__ALL__","",false,function(){$button.removeClass("working");$(".npc-row").removeClass("found");$npc_table.find("input").val("");});});$body.on("mousemove keyup",function(){idle_time=0;});incrementIdleTime=function(){idle_time+=1;if(idle_time>=18){clearTimeout(sync_timer);idle_timer=clearTimeout(idle_timer);$("#toggle-autosync").get(0).checked=false;}};soundManager.setup({url:"/media/soundmanager2.swf",onready:function(){soundManager.createSound({id:"all_found",url:"/media/all_found.mp3"});}});initTable();if(GBT.guild_data&&GBT.search_state){applyState(GBT.search_state);}
if(GBT.guild_data){beginAutoSync();}});