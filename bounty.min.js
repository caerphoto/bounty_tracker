...
$row.toggleClass("found",status.found);$input=$row.find(".player-name input");if(!$input.is(":focus")){$input.val(status.player);}});if(count>=15){if(!has_played_sound){soundManager.play("all_found");has_played_sound=true;}}else{has_played_sound=false;}
