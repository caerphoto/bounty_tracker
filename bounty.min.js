...
$.ajax({url:"api/search_state.php",type:"POST",data:{short_name:short_name,player:player||"",found:!!found},dataType:"json",success:function(response){GBT.search_state=response;applyState();if(typeof callback==="function"){callback(true);}},error:function(xhr){if(typeof callback==="function"){callback(false,xhr.responseText);}}});};beginAutoSync=function(){if($body.hasClass("demo")){return;}
